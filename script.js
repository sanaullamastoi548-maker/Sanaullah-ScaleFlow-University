/*============================================================
   ...
   Version: 1.0 (Final)
   یہ فائل HTML اور CSS کے تمام فیچرز کو چلاتی ہے۔
============================================================*/
...
(function(global) {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            if (page && pageSections[page]) {
                navigateTo(page);
                // اگر صفحہ 1 نہیں ہے تو اس کا عنوان تبدیل کریں (آپشنل)
            }
        });
    });
    ...
    globalSearch?.addEventListener('input', function() {
        ...
        // تمام گیٹ وے کارڈز، کورس کارڈز، پروڈکٹ کارڈز کو فلٹر کریں
    ...
    // ================================================================
    // 12. DASHBOARD STATS — ڈیمو ڈیٹا اپ ڈیٹ (اپنی مرضی سے بدلیں)
    // ================================================================
    function updateDashboardStats() {
        // یہاں آپ Apps Script سے ڈیٹا لا سکتے ہیں، ابھی ڈیمو
        const data = {
            name: 'Sanaullah',
            xp: '250 XP',
            level: 'Level 5',
    ...
    document.querySelectorAll('.btn-primary, .btn-secondary, .btn-danger').forEach(btn => {
        ...
        if (btn.type !== 'submit' && !btn.closest('form')) {
            btn.addEventListener('click', function(e) {
                // اگر بٹن کسی خاص ماڈیول میں نہیں ہے
